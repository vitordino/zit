...
export const CommitLineButton = ({ className, ...props }: JSX.IntrinsicElements['button']) => (
	<button
		className={cn(
			'disabled:text-text-disabled leading-none py-0 text-text-muted focus-visible:text-text hover:text-text text-xs outline-none p-2 hover:bg-background active:bg-element-active data-[active="true"]:bg-element-active focus-visible:bg-element-active ring-1 ring-border ml-[1px] flex-shrink-0',
			className,
		)}
		{...props}
	/>
